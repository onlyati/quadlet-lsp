...
`
	...
	assert.Equal(t, NodePosition{LineNumber: 0, Position: 0}, parser.Quadlet.Documents[0].StartPos)
	assert.Equal(t, NodePosition{LineNumber: 0, Position: 16}, parser.Quadlet.Documents[0].EndPos)
	...
	assert.Equal(t, NodePosition{LineNumber: 2, Position: 0}, containerSection.StartPos)
	assert.Equal(t, NodePosition{LineNumber: 2, Position: 11}, containerSection.EndPos)
	...
	assert.Equal(t, NodePosition{LineNumber: 3, Position: 6}, imageKeywordValue.StartPos)
	assert.Equal(t, NodePosition{LineNumber: 3, Position: 15}, imageKeywordValue.EndPos)
	...
	assert.Equal(t, NodePosition{LineNumber: 7, Position: 0}, unitSection.StartPos)
	assert.Equal(t, NodePosition{LineNumber: 7, Position: 6}, unitSection.EndPos)
